    ...
    export default {
        ...
        methods: {
            handleFilterBrand (brand) {
                if (this.filterBrand .indexOf(brand)!==-1) {
                    this.filterBrand = this.filterBrand.filter(item => item !== brand)
                    //this.filterBrand = '';
                } else {
            ...
            handleFilterColor (color) {
                if (this.filterColor .indexOf(color)!==-1) {
                    this.filterColor = this.filterColor.filter(item => item !== color)
                    //this.filterBrand = '';
                } else {
        ...
        mounted () {
            ...
            setTimeout(()=>{
                this.filterBrand=this.$store.getters.brands
                this.filterColor=this.$store.getters.colors                
            },1000)
